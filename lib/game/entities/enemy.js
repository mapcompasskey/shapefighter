        ...
        isMoving: function() {
            ...
            */
            ...
            if (1 == 1)
            {
                ...
                // gradually decrease the angle based on the velocity
                //this.angleTick += ig.system.tick;
                //var foo = ((this.angleTick * this.angleDistance) / this.angleTime);
                //console.log(this.startAngle - foo);
                //this.radius = (this.startAngle - foo);
                //var angle = (this.angle < this.finalRadius ? this.finalRadius : this.angle);
                //var angle = this.angle;
                //var foo = (this.radiusDistance * this.radius) / aDist;
                console.log(this.startRadius, radius);
                
                // angle needs to increase between the minimum and maximum radius
