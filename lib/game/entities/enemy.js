...
.defines(function() {
    EntityEnemy = ig.Entity.extend({
        ...
        prepareEntity: function() {
            ...
            this.pos.x -= 50;//(50 + rand);
            this.pos.y -= 50;//(50 + rand);
        ...
        isMoving: function() {
            ...
            */
            ...
            if (1 == 0)
            {
                ...
                //var origin_pos_x = Math.sqrt(Math.pow((this.origin.x - this.target.x), 2));
                //var target_pos_x = Math.sqrt(Math.pow((this.target.x - this.pos.x), 2));
                //console.log(origin_pos_x, target_pos_x);
                
                //console.log(Math.round(origin_pos_x), Math.round(target_pos_x));
                //console.log(1 - (target_pos_x / origin_pos_x));
                
                /*if (target_pos_x > (origin_pos_x / 2))
                {
                    this.maxVel.x = (this.speed * 0.4);
                }
                else
                ...
                //this.maxVel.x = this.speed * (target_pos_x / origin_pos_x);
                
                //this.maxVel.x = this.speed * 0.5;
