    ...
    Stage1 = ig.Game.extend({
        ...
        loadLevel: function(data) {
            ...
            */
            ...
            // add enemy
            ig.game.spawnEntity(EntityEnemy, 100, 60);
            ig.game.spawnEntity(EntityEnemy, 120, 60);
            ig.game.spawnEntity(EntityEnemy, 140, 60);
            ig.game.spawnEntity(EntityEnemy, 160, 60);
            ig.game.spawnEntity(EntityEnemy, 180, 60);
            ig.game.spawnEntity(EntityEnemy, 200, 60);
            ig.game.spawnEntity(EntityEnemy, 220, 60);
            //ig.game.spawnEntity(EntityEnemy, 120, 40);
            //ig.game.spawnEntity(EntityEnemy, 140, 40);
